...
// output to ST7735 0.000cm to 2.000cm
 // write this
 uint8_t thousandths = n%10;
 uint8_t hundredths = (n/10)%10;
 uint8_t tenths = (n/100)%10;
 uint8_t ones = (n/1000)%10;
 printf("d=%d.%d%d%d cm   ",ones,tenths,hundredths,thousandths);
