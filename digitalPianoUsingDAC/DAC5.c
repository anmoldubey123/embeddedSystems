...
// I.e., PortB has already been reset and activated (do not reset PortB here again)
     ...
     GPIOB->DOE31_0 |= 0x01; //DOE for PB0
     GPIOB->DOE31_0 |= 0x02; //DOE for PB1
     GPIOB->DOE31_0 |= 0x04; //DOE for PB2
     GPIOB->DOE31_0 |= 0x08; //DOE for PB3
     GPIOB->DOE31_0 |= 0x10; //DOE for PB4
}
